				...
				<td>
					<?php if ($doc->access == 'private') : ?>
						...
						<p class="description">
							...
							<a href="http://issuu.com/home/publications" target="_blank">clique aqui</a>
						</p>
					<?php else: ?>
